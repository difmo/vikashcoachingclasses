    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-8">
      ...
      >
        <div className="md:w-1/2">
          ...
          <p className="text-lg mb-4 text-primary text-justify">
            Vikas Sir is a Gold Medalist in IIT Delhi, MTech Programs for their
            outstanding academic performance and having more than 11 years of
            experience. He has become a synonym for training Physics toppers
            among the top Schools in Delhi and some National Institutes.
            Throughout the years with continued success in teaching, guidance &
            Motivation he made more than 1000's of IITIANS ,NITIANS & Doctors
            till yet. More than 90% of his students had scored more than 90%
            Marks in PHYSICS in Boards, NEET & IIT-JEE continuously under his
            guidance, since many past years. Vikas Sir also likes to teach
            students online across the Globe. So if you want to Score Good
            grades in competitive exams like NEET or IIT-JEE along with Boards
            then connect us for a guaranteed result & Get 1 to 1 Online PHYSICS
            classes with Vikas Sir and make your Concepts sharp & fair by
            clearing yours doubts.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center" data-aos="zoom-in">
          <img
            src={md}
            alt="Vikas Sir"
            className="h-96 md:h-[550px] w-full  object-fill rounded-lg"
          />
        </div>
      </div>
      ...
      <div className="mb-8" data-aos="fade-up">
        ...
        <p className="list-disc list-inside mb-4 text-lg text-primary">
          ...
          experience) on all of our tutors so you can make an informed decision.
        </p>
        ...
        <p className="text-lg mb-4 text-primary">
          ...
          IIT-JEE along with 9th,1Oth, 11th and 12th grade, So connect and join
          our tutors for a guaranteed results.
        </p>
