  ...
  return (
    <>
      <Helmet>
        ...
        <title>
          Hire the Best Online Private Tutors for Physics, Chemistry, Maths & Biology | Vikas Institute
        </title>
        <meta name="google-site-verification" content="E_lsntfktFWor0CLJ5-oipez6gAJ5lvHRX-dOFmj8vw" />
        <meta
          name="description"
          content="Looking for expert online private tutors in Physics, Chemistry, Maths, and Biology? Vikas Institute offers personalized tutoring by top educators to boost your academic success. Book your free demo now!"
        />
        ...
        <meta
          property="og:title"
          content="Hire the Best Online Private Tutors for Physics, Chemistry, Maths & Biology | Vikas Institute"
        />
        <meta
        ...
        {/* Canonical and icons */}
        <link rel="canonical" href="https://www.vikasinstitute.in/" />
        <link
          rel="shortcut icon"
